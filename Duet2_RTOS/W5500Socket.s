...
ARM GAS  C:\Users\THOMAS~1.CAM\AppData\Local\Temp\ccHlfLgR.s 			page 11
 ...
 573 0060 124B     		ldr	r3, .L137
 574 0062 D3F8F430 		ldr	r3, [r3, #244]
 575 0066 9B07     		lsls	r3, r3, #30
 576 0068 D1D5     		bpl	.L118
 577 006a 2946     		mov	r1, r5
 578 006c 1048     		ldr	r0, .L137+4
 579 006e BDE8F840 		pop	{r3, r4, r5, r6, r7, lr}
 580 0072 FFF7FEBF 		b	debugPrintf
 581              	.L136:
 582 0076 00F10C01 		add	r1, r0, #12
 583 007a 1944     		add	r1, r1, r3
 584 007c 2A46     		mov	r2, r5
 585 007e 94F82200 		ldrb	r0, [r4, #34]	@ zero_extendqisi2
 586 0082 FFF7FEFF 		bl	_Z13wiz_recv_datahPht
 587 0086 94F82200 		ldrb	r0, [r4, #34]	@ zero_extendqisi2
 588 008a 4021     		movs	r1, #64
 589 008c FFF7FEFF 		bl	_Z11ExecCommandhh
 590 0090 7368     		ldr	r3, [r6, #4]
 591 0092 064A     		ldr	r2, .L137
 592 0094 2B44     		add	r3, r3, r5
 593 0096 7360     		str	r3, [r6, #4]
 594 0098 D2F8F430 		ldr	r3, [r2, #244]	@ unaligned
 595 009c 9A07     		lsls	r2, r3, #30
 596 009e B6D5     		bpl	.L118
 597 00a0 2946     		mov	r1, r5
 598 00a2 0448     		ldr	r0, .L137+8
 599 00a4 BDE8F840 		pop	{r3, r4, r5, r6, r7, lr}
 600 00a8 FFF7FEBF 		b	debugPrintf
 601              	.L138:
 602              		.align	2
 603              	.L137:
 604 00ac 00000000 		.word	reprap
 605 00b0 14000000 		.word	.LC1
 606 00b4 00000000 		.word	.LC0
...
ARM GAS  C:\Users\THOMAS~1.CAM\AppData\Local\Temp\ccHlfLgR.s 			page 13
 ...
 723 011a 0BD3     		bcc	.L167
 724 011c D5F8F430 		ldr	r3, [r5, #244]
 725 0120 9B07     		lsls	r3, r3, #30
 726 0122 03D5     		bpl	.L153
 727 0124 2189     		ldrh	r1, [r4, #8]
 728 0126 1D48     		ldr	r0, .L170+4
 729 0128 FFF7FEFF 		bl	debugPrintf
 730              	.L153:
 731 012c 2368     		ldr	r3, [r4]
 732 012e 2046     		mov	r0, r4
 733 0130 9B68     		ldr	r3, [r3, #8]
 734 0132 9847     		blx	r3
 735              	.L167:
 736 0134 237D     		ldrb	r3, [r4, #20]	@ zero_extendqisi2
 737              	.L149:
 738 0136 032B     		cmp	r3, #3
...
ARM GAS  C:\Users\THOMAS~1.CAM\AppData\Local\Temp\ccHlfLgR.s 			page 14
 ...
 743 0142 16FB0070 		smlabb	r0, r6, r0, r7
 744 0146 C000     		lsls	r0, r0, #3
 745 0148 3246     		mov	r2, r6
 746 014a 04F11001 		add	r1, r4, #16
 747 014e 00F54060 		add	r0, r0, #3072
 748 0152 FFF7FEFF 		bl	_Z16WIZCHIP_READ_BUFmPht
 749 0156 94F82280 		ldrb	r8, [r4, #34]	@ zero_extendqisi2
 750 015a 16FB0878 		smlabb	r8, r6, r8, r7
 751 015e 4FEAC808 		lsl	r8, r8, #3
 752 0162 08F58050 		add	r0, r8, #4096
 753 0166 FFF7FEFF 		bl	_Z12WIZCHIP_READm
 754 016a 8146     		mov	r9, r0
 755 016c 08F58850 		add	r0, r8, #4352
 756 0170 FFF7FEFF 		bl	_Z12WIZCHIP_READm
 757 0174 94F82230 		ldrb	r3, [r4, #34]	@ zero_extendqisi2
 758 0178 16FB0376 		smlabb	r6, r6, r3, r7
 759 017c 00EB0920 		add	r0, r0, r9, lsl #8
 760 0180 F600     		lsls	r6, r6, #3
 761 0182 6081     		strh	r0, [r4, #10]	@ movhi
 762 0184 3946     		mov	r1, r7
 763 0186 06F50070 		add	r0, r6, #512
 764 018a FFF7FEFF 		bl	_Z13WIZCHIP_WRITEmh
 765 018e FFF7FEFF 		bl	millis
 766 0192 E061     		str	r0, [r4, #28]
 767 0194 8FE7     		b	.L148
 768              	.L171:
 769 0196 00BF     		.align	2
 770              	.L170:
 771 0198 00000000 		.word	reprap
 772 019c 00000000 		.word	.LC2
